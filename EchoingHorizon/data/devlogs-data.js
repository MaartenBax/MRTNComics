      ...
      sections: [
        ...
        },
        {
          blocks: [
            ...
            {
              items: ["Cards are generated automatically on the overview page.", "Long articles receive jump links for selected sections.", "Previous and next navigation is calculated from the publication order.", "Each post receives its own title, description and share metadata."],
              ordered: false,
              type: "list",
            },
          ],
      ...
      sections: [
        {
          ...
          blocks: [
            {
              type: "paragraph",
              text: "Memory objects need to be readable enough to recognize, but not so physically convincing that they feel permanent. Fully solid props communicate presence too strongly; they begin to look like ordinary set dressing rather than incomplete reconstruction.",
            },
            {
              type: "quote",
              text: "The object should look like it is there, while never feeling completely real.",
            },
          ],
        },
        {
          ...
          blocks: [
            {
              ...
              alt: "Fragmented geometric reconstruction",
              caption: "A placeholder study for fragmented memory geometry.",
              width: "wide",
            },
            {
              type: "paragraph",
              text: "The current direction uses broken silhouettes, sparse points and subtle internal motion. The form remains identifiable from a distance, while close inspection reveals that it is unstable and incomplete.",
            },
            {
              type: "video",
              src: "",
              poster: "../assets/gallery-3.svg",
              caption: "Motion tests can be placed here when a local MP4 is available.",
            },
          ],
        },
        {
          ...
          blocks: [
            {
              type: "paragraph",
              text: "The visual system becomes more meaningful when it responds to the player. Reconstructed objects may become clearer near specific viewpoints, destabilize after a puzzle is solved or reveal new information when light passes through them.",
            },
            {
              type: "gallery",
              images: [
                {
                  ...
                  alt: "Echoing Horizon gallery study one",
                  caption: "Environment study",
                },
                {
                  src: "../assets/gallery-4.svg",
                  alt: "Echoing Horizon gallery study two",
                  caption: "Lighting study",
                },
              ],
            },
          ],
      ...
      sections: [
        {
          ...
          blocks: [
            {
              type: "paragraph",
              text: "The first prototypes focus on a small vocabulary of interactions: redirecting beams, rotating mirrors and using blockers to control where light can travel. The challenge is not inventing more mechanics, but finding spaces where the existing ones create meaningful decisions.",
            },
          ],
        },
        {
          ...
          blocks: [
            {
              type: "paragraph",
              text: "Puzzles are not intended to be timed or deliberately frustrating. The player should understand what the room is asking before solving it. Difficulty should come from reasoning, not from fighting the controls or searching for an invisible rule.",
            },
            {
              type: "comparison",
              before: {
                ...
                alt: "Earlier puzzle layout",
              },
              after: {
                label: "After",
                image: "../assets/gallery-4.svg",
                alt: "Revised puzzle layout",
              },
              caption: "A comparison block can show revisions side by side.",
            },
          ],
        },
        {
          ...
          blocks: [
            {
              type: "paragraph",
              text: "The next pass will test how moving platforms and reconstructed objects can interact with the beam system without making the puzzle language feel crowded.",
            },
          ],
        },
      ],
